...
if dataset_to_use == 'GFRC':
    ...
    if bin_yn:
            # Bin
        files_location_valid = "/data/old_home_dir/ChrissyF/GFRC/yolo_train1248_bin/"
        save_dir = "/home/cmf21/pytorch_save/GFRC/Bin/" + name_out + "/"
        out_dir = "/home/cmf21/pytorch_save/GFRC/Bin/" + name_out + "_hnm/"
        nclazz = 1
        ...
        save_dir = "/home/cmf21/pytorch_save/GFRC/Multi/" + name_out + "_hnm/"
        nclazz = 6
        if name_out == 'grey_baseline':
            nn = 274
...
output_path = out_dir + "boxes_out" + str(nn) + "_full.csv"
