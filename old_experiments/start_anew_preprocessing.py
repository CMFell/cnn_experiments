...
def parse_annotation(ann_dir, img_dir, labels=[]):
    ...
    for ann in sorted(os.listdir(ann_dir)):
        ...
        #     print(img)
        all_imgs += [img]
    print(len(all_imgs), len(os.listdir(ann_dir)))
            ...
            for train_instance in self.images[l_bound:r_bound]:
                ...
                for obj in all_objs:
                    ...
                    if obj['xmax'] > obj['xmin'] and obj['ymax'] > obj['ymin'] and obj['name'] in self.config['LABELS']:
                        center_x_wi = .5 * (obj['xmin'] + obj['xmax'])
                        center_x = center_x_wi / (float(self.config['IMAGE_W']) / self.config['GRID_W'])
                        center_y_wi = .5 * (obj['ymin'] + obj['ymax'])
                        center_y = center_y_wi / (float(self.config['IMAGE_H']) / self.config['GRID_H'])
                        ...
                        if grid_x < self.config['GRID_W'] and grid_y < self.config['GRID_H']:
                            ...
                            b_batch[instance_count, 0, 0, 0, true_box_index] = [center_x_wi, center_y_wi, center_w, center_h]
