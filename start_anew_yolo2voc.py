...
ANNOTATIONS_DIR_PREFIX = "E:/CF_Calcs/BenchmarkSets/GFRC/yolo_valid384_ann/"

IMAGE_DIR_PREFIX = "E:/CF_Calcs/BenchmarkSets/GFRC/yolo_valid384_img"

DESTINATION_DIR = "E:/CF_Calcs/BenchmarkSets/GFRC/yolo_valid384_ann_voc/"
...
def read_file(file_path):
    ...
    with open(ANNOTATIONS_DIR_PREFIX + file_path, 'r') as file:
        ...
        for line in lines:
            ...
            if data[0]!='NA':
                clz = data[0]
                clz = str(int(float(clz)))
                voc.append(CLASS_MAPPING.get(clz))
