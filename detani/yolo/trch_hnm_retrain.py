...
if dataset_to_use == 'GFRC':
    ...
    if bin_yn:
        # GFRC Binary values
        files_location = "/data/old_home_dir/ChrissyF/GFRC/yolo_train1248_bin_hnm/"
...
reload_weights = "/home/cmf21/pytorch_save/GFRC/Bin/rgb_baseline2/testing_save_163.pt"
...
save_dict = {'dataset_to_use': dataset_to_use, 'bin_yn': bin_yn, 'orig_size': orig_size, 'name_out': name_out,
    ...
    'bat_sz': bat_sz, 'learn_rate': learn_rate, 'moment': moment, 'weight_d': weight_d, nclazz_hnm: nclazz_hnm}
...
net.load_state_dict(torch.load(reload_weights))
