...
from window.preprocess.transforms import Rotate, FlipRotate
...
# create positive patches from truths
...
# create positive patches from positives of output
tile_img_size = [1856, 1258]
output_from_yolo_bin = "/home/cmf21/pytorch_save/GFRC/Bin/rgb_baseline2/boxes_out163_full_train.csv"
outputdir_pos = "/data/old_home_dir/ChrissyF/GFRC/window_classifier/bin_class/animals/"
yolo_output_in = pd.read_csv(output_from_yolo_bin)
yolo_output_fil = yolo_output_in.loc[yolo_output_in.tp > 0.1, :]
# negative different filenames and does not jitter
pos_windows_df = process_annotation_df_negative(yolo_output_fil, tile_img_size)
create_negative_patches(pos_windows_df, outputdir_pos, augments_list, 1)

# create negative windows from false positives of output
tile_img_size = [1856, 1258]
output_from_yolo_bin = "/home/cmf21/pytorch_save/GFRC/Bin/rgb_baseline2/boxes_out163_full_train.csv"
outputdir_neg = "/data/old_home_dir/ChrissyF/GFRC/window_classifier/bin_class/not_animals/"
yolo_output_in = pd.read_csv(output_from_yolo_bin)
...
create_negative_patches(neg_windows_df, outputdir_neg, augments_list, 8)

# create valid windows from yolo output subset
tile_img_size = [1856, 1248]
output_from_yolo_valid = "/home/cmf21/pytorch_save/GFRC/Bin/rgb_baseline2/boxes_out163_full.csv"
outputdir_valid_pos = "/data/old_home_dir/ChrissyF/GFRC/window_classifier/valid_bin_class/animals/"
outputdir_valid_neg = "/data/old_home_dir/ChrissyF/GFRC/window_classifier/valid_bin_class/not_animals/"
yolo_output_val = pd.read_csv(output_from_yolo_valid)
yolo_output_val_pos = yolo_output_val.loc[yolo_output_val.tp >= 0.1, :]
yolo_output_val_neg = yolo_output_val.loc[yolo_output_val.tp < 0.01, :]
# negative different filenames and does not jitter
